	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container ml-0">
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				<ul class="navbar-nav">
					<li class="nav-item <?php if ($currentPage == SITEURL) {
											echo "active";
										} ?> ">
					...
					if (empty($user)) {
					?>
						<li class="nav-item <?php if ($currentPage == SITEURL . "signup.php") {
												echo "active";
											} ?>">
							<a class="nav-link" href="<?php echo SITEURL . "signup.php" ?>">Signup</a>
						</li>
						<li class="nav-item <?php if ($currentPage == SITEURL . "login.php") {
												echo "active";
											} ?>">
					...
					if (!empty($user)) {
					?>
						<li class="nav-item <?php if ($currentPage == SITEURL . "addcontact.php") {
												echo "active";
											} ?>">
							<a class="nav-link" href="<?php echo SITEURL . "addcontact.php" ?>">Add Contact</a>
						</li>
						<li class="nav-item dropdown <?php if ($currentPage == SITEURL . "profile.php") {
															echo "active";
														} ?> ">
